...
private:
    ...
    /// any local ipv4 to put in destination advertisements,
    /// including the peer router ipv4
    LLDLEP::DataItems localPeerIpv4DataItems;

    /// any local ipv4 subnet to put in destination advertisements,
    /// including the peer router ipv4 subnet
    LLDLEP::DataItems localPeerIpv4SnDataItems;

    /// any local ipv6 to put in destination advertisements,
    /// including the peer router ipv6
    LLDLEP::DataItems localPeerIpv6DataItems;

    /// any local ipv6 subnet to put in destination advertisements,
